...
| **Community Detection** | `Louvain` | - | Blondel, V. D., Guillaume, J.-L., Lambiotte, R., & Lefebvre, E. (2008). [Fast unfolding of communities in large networks](https://arxiv.org/pdf/0803.0476). Journal of Statistical Mechanics: Theory and Experiment, 2008(10), P10008. |
