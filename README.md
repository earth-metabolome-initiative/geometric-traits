...
| **Modular Product** | `ModularProduct` | O(\|P\|²) | [`modular_product.rs`](fuzz/fuzz_targets/modular_product.rs) | Barrow, H. G., & Burstall, R. M. (1976). [Subgraph isomorphism, matching relational structures and maximal cliques](https://doi.org/10.1016/0020-0190(76)90049-1). *Information Processing Letters*, 4(4), 83–84. |
| **Labeled Modular Product** | `LabeledModularProduct` | O(\|P\|²·row) | [`labeled_modular_product.rs`](fuzz/fuzz_targets/labeled_modular_product.rs) | Labeled variant: edge compatibility requires matching `Option<Value>` labels. Building block for labeled MCES / RASCAL. |
...
| **Maximum Matching (Kocay)** | `Kocay` | O(V²E) | [`kocay.rs`](fuzz/fuzz_targets/kocay.rs) | Kocay, W. (2005). [An extension of the multi-path algorithm for finding the initial flow in a minimum cost flow problem](https://doi.org/10.1016/j.dam.2004.08.004). *Discrete Applied Mathematics*, 149(1-3), 154–165. |
