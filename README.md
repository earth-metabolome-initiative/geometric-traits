...
| **Rectangular Assignment (Crouse LAPJV)** | `Crouse` | O(min(n,m)²·max(n,m)) | - | Crouse, D. F. (2016). [On implementing 2D rectangular assignment algorithms](https://dblp.org/rec/journals/taes/Crouse16). *IEEE Transactions on Aerospace and Electronic Systems*, 52(4), 1679-1696. DOI: `10.1109/TAES.2016.140952`. |
