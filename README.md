...
|-----------|-------|-----------------|-----------|
| **Linear Assignment Problem** | `SparseLAPJV` | [`lapjv.rs`](https://github.com/earth-metabolome-initiative/geometric-traits/blob/main/fuzz/fuzz_targets/lapjv.rs) | Jonker, R., & Volgenant, A. (1987). [A shortest augmenting path algorithm for dense and sparse linear assignment problems](https://doi.org/10.1007/BF02278710). Computing, 38, 325-340. |
