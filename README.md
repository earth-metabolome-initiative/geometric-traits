...
| **All-Pairs Shortest Paths (Weighted)** | `FloydWarshall` | O(V³) | [`floyd_warshall.rs`](fuzz/fuzz_targets/floyd_warshall.rs) | Floyd, R. W. (1962). [Algorithm 97: Shortest path](https://cacm.acm.org/research/algorithm-97-shortest-path/). *Communications of the ACM*, 5(6), 345. Warshall, S. (1962). [A theorem on Boolean matrices](https://www.sigmod.org/publications/dblp/db/journals/jacm/Warshall62.html). *Journal of the ACM*, 9(1), 11-12. |
