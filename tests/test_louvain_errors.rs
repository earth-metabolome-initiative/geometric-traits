...
fn test_louvain_error_unrepresentable_weight() {
    let e = LouvainError::UnrepresentableWeight { source: 1, destination: 2 };
    let s = format!("{e}");
...
fn test_louvain_error_non_finite_weight() {
    let e = LouvainError::NonFiniteWeight { source: 0, destination: 3 };
    let s = format!("{e}");
...
fn test_louvain_error_non_positive_weight() {
    let e = LouvainError::NonPositiveWeight { source: 2, destination: 4 };
    let s = format!("{e}");
...
fn test_louvain_error_non_symmetric_edge() {
    let e = LouvainError::NonSymmetricEdge { source: 1, destination: 5 };
    let s = format!("{e}");
